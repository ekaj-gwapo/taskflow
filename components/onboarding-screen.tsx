...
export function OnboardingScreen() {
  ...
  const { login, logout, currentUser, isLoadingSession } = useTaskContext()
    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-b from-background to-secondary/20">
      <AnimatePresence mode="wait">
        {step === "splash" ? (
          ...
          >
            <div className="inline-flex h-24 w-24 items-center justify-center rounded-3xl bg-primary/10 mb-4">
              <Rocket className="h-12 w-12 text-primary animate-pulse" />
            </div>
            <h2 className="text-4xl font-black tracking-tight text-foreground">Ready to Launch?</h2>
            ...
            <div className="flex flex-col gap-3 pt-6">
              ...
              <Button
                ...
                className="w-full h-14 rounded-2xl font-bold text-muted-foreground hover:text-foreground hover:bg-secondary/50 transition-all"
              >
                Cancel & Log Out
              </Button>
            </div>
                ...
                <form onSubmit={handleCreateOrg} className="space-y-5">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button
                      ...
                      className="w-full h-12 rounded-xl font-bold text-muted-foreground hover:text-foreground hover:bg-secondary/50"
                      disabled={loading}
                    >
                      Back
                    </Button>
